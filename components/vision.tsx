        ...
        <div className="col-span-6 flex flex-col justify-center">
          ...
          >
            <p className="text-grey md:text-lg font-normal mb-10 text-start mt-2">
              Our main mission is to empower patients. We are committed to
              providing personalized exercise recommendations using AI
              algorithms. By understanding each patient’s unique needs, we aim
              to enhance their physical health and overall quality of life.{" "}
            </p>{" "}
          </Fade>
        </div>
      </div>
